...
struct DAG_task
{
	...
	int u;									// the utilization of this task that u = x means the utilization is equal to 0.x  
	int task_set;							// which task set is. the total number of task sets is 1000
	int WCRT;								// the worst case response time of a DAG task
	int schedulable;						// wheather this DAG task can be scheduled
